...
local function set_groups()
	...
	local groups = {
		...
		Comment = { fg = colors.fg, italic = config.italics.comments or false },

		Constant = { fg = colors.gray },
		String = { fg = colors.fg, italic = config.italics.strings or false },
		...
		FunctionDefinition = { fg = colors.white, bold = true },
		Method = { fg = colors.fg },
		...
		-- ["@float"] = {},
		["@function"] = { link = "FunctionDefinition", italic = config.italics.functions or false },
